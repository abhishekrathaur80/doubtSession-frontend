import { Box, Button, Heading, Input, Image, useToast } from "@chakra-ui/react";
...
const Login = () => {
  ...
  const { loggedinname, token, errmsg, isLoading, usertype } = useSelector(
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Box w="100%">
            <Image src={signupquesimg} borderRadius={"10px"} />
          </Box>
        </Box>
      </Box>
